  ...
  return(
    <>
      <div className="pt-28 min-h-screen">
        <div className={`${btnClick ? '-translate-x-full transition-all duration-300' : ''} ${load ? '-translate-x-0 transition-all duration-300' : 'translate-x-full'} flex items-center justify-center mt-20 bg-neutral-800 w-4/6 mx-auto p-10 text-neutral-200 rounded-md`}>
