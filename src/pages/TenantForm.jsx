  ...
  return(
    <>
      <div className="pt-28 min-h-screen">
        <div className={`${disagreeClick ? '-translate-x-full transition-all duration-300' : ''} ${load ? '-translate-x-0 transition-all duration-300' : 'translate-x-full'} flex items-center justify-center mt-20 bg-neutral-800/80 w-2/6 mx-auto p-10 text-neutral-200 rounded-xl`}>
          <div className="">
            <form>
              ...
              <input type="phone" id="notel" placeholder="Nomor telp" className="w-full p-2 px-4 bg-neutral-700 rounded-xl" />
              <br /><br />
